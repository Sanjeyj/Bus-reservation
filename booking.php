...
<form class="ui form attached fluid loading segment" onsubmit="return contact(this)">
 ...
 <div class="field">
    <select required id="destination">
      ...
      <option>Madurai to Coimbatore</option>
	   <option>Trichy to Chennai</option>
	    <option>Coimbatore to Selam </option>
    </select>
  </div>   
  </div>
<div class="field">  
...
<label>Payment</label>  
    <select name="gender" required id="paymentmethod">
      ...
      <option value="MPESA">GPay</option>
      <option value="KCD_BANK">Phone Pay</option>
	  <option value="EQUITY_BANK">Card</option>
    </select>
  </div> 
<div class="field"> 
